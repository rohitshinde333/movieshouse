        ...
        verifyButton.addEventListener('click', () => {
            if (isTakingPhoto && capturedPhotoData) {
                ...
                .then(response => {
                    ...
                    // Apply CSS styles to the response div
                    responseDiv.style.backgroundColor = '#f0f0f0';  // Set background color
                    responseDiv.style.border = '1px solid #ccc';     // Add a border
                    responseDiv.style.padding = '10px';             // Add padding
                    responseDiv.style.fontFamily = 'Arial, sans-serif'; // Set font family
                    responseDiv.style.fontSize = '16px';            // Set font size
                    responseDiv.style.margin = '10px';              // Add margin
                    responseDiv.style.maxWidth = '600px';           // Limit the maximum width
                    
                    // Append the styled response div to the body
